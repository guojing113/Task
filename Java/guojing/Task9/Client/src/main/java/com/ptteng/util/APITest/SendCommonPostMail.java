...
public class SendCommonPostMail {
    ...
    public static void main(String[] args) throws IOException {
        ...
        final String apiUser = "yixiaoyixiaonian_test_UIURNk";
        final String apiKey = "RR1wLgGm9VYYAhJy";
        ...
        params.add(new BasicNameValuePair("fromName", "tomcat.com"));
        params.add(new BasicNameValuePair("to", "601889774@qq.com"));
