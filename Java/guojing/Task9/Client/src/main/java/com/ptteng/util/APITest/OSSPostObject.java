package com.ptteng.util.APITest;
...
public class OSSPostObject {
    // 上传文件
    private String localFilePath = "C:\\Users\\Administrator\\Desktop\\任务六\\任务六脑图.jpg";
    // Endpoint以杭州为例，其它Region请按实际情况填写。
    private String endpoint = "http://oss-cn-beijing.aliyuncs.com";
    // 阿里云主账号AccessKey拥有所有API的访问权限，风险很高。强烈建议您创建并使用RAM账号进行API访问或日常运维，请登录 https://ram.console.aliyun.com 创建RAM账号。
    private String accessKeyId = "LTAIWk8e0ABTv06j";
    private String accessKeySecret = "lTBP3RGidyJpSZG023Umi6ACASIyqe";
    // 存储空间名称
    private String bucketName = "pttengguojing";
    // 文件名称
    private String objectName = "任务六脑图";
    /**
     * 表单上传
     * @throws Exception
     */
...
//        这里注意下，加载的CalbackBodyType类不确定对不对
