...
//  阿里云图片上传
    ...
    public ModelAndView updatePicture(HttpServletRequest request, String tel,
                                MultipartFile pictureFile, ModelAndView modelAndView) throws Exception {

        //上传OSS
//      key是图片文件的唯一标识
        String key=tel+String.valueOf(System.currentTimeMillis())+".jpg";
        System.out.println("测试一下"+key);
        System.out.println("测试入参"+tel);
...
//    腾讯云图片上传
    ...
    public ModelAndView Picture(HttpServletRequest request, String tel,
                                MultipartFile pictureFile, ModelAndView modelAndView) throws Exception {
