...
<header>
    ...
    <div class="top1" style="display: block;!important;">
        <%--<img class="ji" src="images/zln.jpg" alt="请上传图像"  height="60" width="60">--%>
        <a href="/login.jsp">登陆</a><span>|</span><a href="/register.jsp">注册</a>|</span><a
        href="${pageContext.request.contextPath}/loginOut">注销</a>|</span><a
            href="${pageContext.request.contextPath}/pictureupload">上传图像</a>
    </div>
