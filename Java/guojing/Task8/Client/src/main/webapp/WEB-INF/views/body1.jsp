<%@ page import="com.ptteng.listener.UserList" %>
...
<div class="section1 w">
    ...
    <div class="right hidden-sm hidden-xs">
        <div class="content">
            <div class="num">
                <img src="images/user.jpg" alt=""> <span><%=(UserList.getUserCount())/3%></span>
                <p>累计登录人数</p>
            </div>
            <div class="num">
                <img src="images/user.jpg" alt=""> <span>${applicationScope.count }</span>
                <p>累计在线学习人数</p>
            </div>
        </div>
    </div>
